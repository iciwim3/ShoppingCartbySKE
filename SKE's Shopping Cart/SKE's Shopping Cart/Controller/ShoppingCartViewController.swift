...
class ShoppingCartViewController: UIViewController {
    ...
    @IBAction func item1StepperPressed(_ sender: UIStepper) {
    ...
    @IBAction func item2StepperPressed(_ sender: UIStepper) {
        let newQuantity = Int(sender.value)
    ...
    @IBAction func item3StepperPressed(_ sender: UIStepper) {
        let newQuantity = Int(sender.value)
